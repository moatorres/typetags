...
export const isArrayIteratorTag = predicate('Array.Iterator')
...
export const isGlobalTag = predicate('Global')
...
export const isStringIteratorTag = predicate('String.Iterator')
export const isSymbolTag = predicate('Symbol')
export const isSyntaxErrorTag = predicate('SyntaxError')
export const isTextDecoderTag = predicate('TextDecoder')
export const isTextEncoderTag = predicate('TextEncoder')
...
export const isURLTag = predicate('URL')
export const isURLSearchParamsTag = predicate('URLSearchParams')
