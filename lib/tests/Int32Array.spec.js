...
describe('Int32Array', () => {
  ...
  it('Should have a predicate', () => {
    expect(TypeTags.isInt32Array).toBeDefined()
    expect(TypeTags.isInt32Array(int32array)).toBeTrue()
    expect(TypeTags.isInt32Array(toString(int32array))).toBeTrue()
    expect(TypeTags.isInt32Array(TypeTags.Int32Array)).toBeTrue()
  })
})
