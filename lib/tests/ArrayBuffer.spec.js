...
describe('ArrayBuffer', () => {
  ...
  it('Should have a predicate', () => {
    expect(TypeTags.isArrayBuffer).toBeDefined()
    expect(TypeTags.isArrayBuffer(arrayBuffer)).toBeTrue()
    expect(TypeTags.isArrayBuffer(toString(arrayBuffer))).toBeTrue()
    expect(TypeTags.isArrayBuffer(TypeTags.ArrayBuffer)).toBeTrue()
  })
})
