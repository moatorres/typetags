...
describe('Arguments', () => {
  ...
  it('Should have a predicate', () => {
    expect(TypeTags.isArguments).toBeDefined()
    expect(TypeTags.isArguments(arguments)).toBeTrue()
    expect(TypeTags.isArguments(toString(arguments))).toBeTrue()
    expect(TypeTags.isArguments(TypeTags.Arguments)).toBeTrue()
  })
})
