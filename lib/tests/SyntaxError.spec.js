...
describe('SyntaxError', () => {
  ...
  it('Should have a predicate', () => {
    expect(TypeTags.isSyntaxError).toBeDefined()
    expect(TypeTags.isSyntaxError(errCons)).toBeTrue()
    expect(TypeTags.isSyntaxError(toString(errCons))).toBeTrue()
    expect(TypeTags.isSyntaxError(TypeTags.SyntaxError)).toBeTrue()
  })
})
