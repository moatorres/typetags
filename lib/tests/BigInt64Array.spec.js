...
describe('BigInt64Array', () => {
  ...
  it('Should have a predicate', () => {
    expect(TypeTags.isBigInt64Array).toBeDefined()
    expect(TypeTags.isBigInt64Array(bigint64)).toBeTrue()
    expect(TypeTags.isBigInt64Array(toString(bigint64))).toBeTrue()
    expect(TypeTags.isBigInt64Array(TypeTags.BigInt64Array)).toBeTrue()
  })
})
