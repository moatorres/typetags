...
describe('BigInt', () => {
  ...
  it('Should have a predicate', () => {
    expect(TypeTags.isBigInt).toBeDefined()
    expect(TypeTags.isBigInt(bigint)).toBeTrue()
    expect(TypeTags.isBigInt(toString(bigint))).toBeTrue()
    expect(TypeTags.isBigInt(TypeTags.BigInt)).toBeTrue()
  })
})
