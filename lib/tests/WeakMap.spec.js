...
describe('WeakMap', () => {
  ...
  it('Should have a predicate', () => {
    expect(TypeTags.isWeakMap).toBeDefined()
    expect(TypeTags.isWeakMap(weakmap)).toBeTrue()
    expect(TypeTags.isWeakMap(toString(weakmap))).toBeTrue()
    expect(TypeTags.isWeakMap(TypeTags.WeakMap)).toBeTrue()
  })
})
