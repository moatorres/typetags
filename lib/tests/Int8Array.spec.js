...
describe('Int8Array', () => {
  ...
  it('Should have a predicate', () => {
    expect(TypeTags.isInt8Array).toBeDefined()
    expect(TypeTags.isInt8Array(int8array)).toBeTrue()
    expect(TypeTags.isInt8Array(toString(int8array))).toBeTrue()
    expect(TypeTags.isInt8Array(TypeTags.Int8Array)).toBeTrue()
  })
})
