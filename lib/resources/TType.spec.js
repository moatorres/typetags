...
import { generateTypeTags, getProps, toString } from '../utils'
...
describe('TType', () => {
  ...
  describe('.typeOf', () => {
    ...
    // TODO: should be a property instead of a method?
  ...
  describe('.info', () => {
    ...
    it('Should return relevant metadata for the current type', () => {
      ...
      expect(meta.isGlobal).toEqual(arrayType.isGlobal())
