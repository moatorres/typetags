...
const withProperties = (o, opts = {}) => {
  ...
  const prototypeDescriptors = { prototypeDescriptors: getDescriptors(o.__proto__) } // prettier-ignore
...
const withName = (o) => {
  ...
  if (typeof o === 'function') {
    // we name nested-types as "<type>.<nested>"
    // their original names are "<nested>" only
