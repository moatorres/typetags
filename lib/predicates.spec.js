...
describe('isAbortControllerTag', () => {
  it('Should be defined', () => {
    expect(P.isAbortControllerTag).toBeDefined()
  })

  it('Should allow us to check if a string is a default AbortController typetag', () => {
    expect(P.isAbortControllerTag(invalidTag)).toBeFalse()
    expect(P.isAbortControllerTag(TypeTags.AbortController)).toBeTrue()
  })
})

describe('isAbortSignalTag', () => {
  it('Should be defined', () => {
    expect(P.isAbortSignalTag).toBeDefined()
  })

  it('Should allow us to check if a string is a default AbortSignal typetag', () => {
    expect(P.isAbortSignalTag(invalidTag)).toBeFalse()
    expect(P.isAbortSignalTag(TypeTags.AbortSignal)).toBeTrue()
  })
})
...
describe('isArrayIteratorTag', () => {
  it('Should be defined', () => {
    expect(P.isArrayIteratorTag).toBeDefined()
  })

  it('Should allow us to check if a string is a default Array Iterator typetag', () => {
    expect(P.isArrayIteratorTag(invalidTag)).toBeFalse()
    expect(P.isArrayIteratorTag(TypeTags['Array.Iterator'])).toBeTrue()
  })
})
...
describe('isGlobalTag', () => {
  it('Should be defined', () => {
    expect(P.isGlobalTag).toBeDefined()
  })

  it('Should allow us to check if a string is a default global typetag', () => {
    expect(P.isGlobalTag(invalidTag)).toBeFalse()
    expect(P.isGlobalTag(TypeTags.Global)).toBeTrue()
  })
})
...
describe('isReflectTag', () => {
  it('Should be defined', () => {
    expect(P.isReflectTag).toBeDefined()
  })

  it('Should allow us to check if a string is a default Reflect typetag', () => {
    expect(P.isReflectTag(invalidTag)).toBeFalse()
    expect(P.isReflectTag(TypeTags.Reflect)).toBeTrue()
  })
})
...
describe('isStringIteratorTag', () => {
  it('Should be defined', () => {
    expect(P.isStringIteratorTag).toBeDefined()
  })

  it('Should allow us to check if a string is a default String Iterator typetag', () => {
    expect(P.isStringIteratorTag(invalidTag)).toBeFalse()
    expect(P.isStringIteratorTag(TypeTags['String.Iterator'])).toBeTrue()
  })
})
...
describe('isTextDecoderTag', () => {
  it('Should be defined', () => {
    expect(P.isTextDecoderTag).toBeDefined()
  })

  it('Should allow us to check if a string is a default TextDecoder typetag', () => {
    expect(P.isTextDecoderTag(invalidTag)).toBeFalse()
    expect(P.isTextDecoderTag(TypeTags.TextDecoder)).toBeTrue()
  })
})

describe('isTextEncoderTag', () => {
  it('Should be defined', () => {
    expect(P.isTextEncoderTag).toBeDefined()
  })

  it('Should allow us to check if a string is a default TextEncoder typetag', () => {
    expect(P.isTextEncoderTag(invalidTag)).toBeFalse()
    expect(P.isTextEncoderTag(TypeTags.TextEncoder)).toBeTrue()
  })
})
...
describe('isURLTag', () => {
  it('Should be defined', () => {
    expect(P.isURLTag).toBeDefined()
  })

  it('Should allow us to check if a string is a default URL typetag', () => {
    expect(P.isURLTag(invalidTag)).toBeFalse()
    expect(P.isURLTag(TypeTags.URL)).toBeTrue()
  })
})

describe('isURLSearchParamsTag', () => {
  it('Should be defined', () => {
    expect(P.isURLSearchParamsTag).toBeDefined()
  })

  it('Should allow us to check if a string is a default URLSearchParams typetag', () => {
    expect(P.isURLSearchParamsTag(invalidTag)).toBeFalse()
    expect(P.isURLSearchParamsTag(TypeTags.URLSearchParams)).toBeTrue()
  })
})
