...
TypeTags.isArray(tag) // → false

console.log(TypeTags.get(arr)) // → '[object Array]'
```
...
If you're using `common-js`, you can destructure on import as well.
